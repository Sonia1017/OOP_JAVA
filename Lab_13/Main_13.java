package ua.lpnuai.oop.heletiy13;
...
public class Main_13 {
    ...
    public static final String ANSI_BLEAK = "\u001B[35m";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ANSI_BLUE + "Single: " + (System.currentTimeMillis() - start) + " milliseconds" + ANSI_RESET);
        ...
        System.out.println(ANSI_BLEAK + "Parallel with sleeping for 1 sec: " + (System.currentTimeMillis() - start) + " milliseconds" + ANSI_RESET);
